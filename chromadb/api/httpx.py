...
class HttpxAPI(ServerAPI):
    ...
    def resolve_url(
        ...
        HttpxAPI._validate_host(_chroma_server_host)
    ...
    def __init__(self, system: System):
        ...
        system.settings.require("chroma_httpx_mode")
        ...
        self._client.headers.update(system.settings.chroma_server_headers)

        self._api_url = HttpxAPI.resolve_url(
